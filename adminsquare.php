<?php 
$title = 'Admin - Square Integration';
include 'header.php'; 
?>
...
<td width=300 height=300 colspan=1 rowspan=3 valign=top align=left>
	...
	<td width="55%">
		See <a href="https://docs.connect.squareup.com/api/connect/v1/" target="_blank">https://docs.connect.squareup.com/api/connect/v1/</a>
	</td>
	</tr>
</table>
