...
<td width=300 height=300 colspan=1 rowspan=3 valign=top align=left>
	...
	<tr>
	<td width="5%"></td><br> 
	<td width="40%"><img  border=0 src="cust1.jpg" usemap="#map397"></td>
	<td width="55%"><a href="newcust.php"><font color="#8B4513" face="Comic Sans MS, arial, Century Gothic" size=6>=> Add New Customer</font></a><br><br>
			...
			<a href="custdel.php"><font color="#8B4513" face="Comic Sans MS, arial, Century Gothic" size=6>=> Delete Customer</font></a><br><br></td></font>
